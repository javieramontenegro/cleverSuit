...
import Brand from "./BrandAgile";
import BurgerMenu from "./BurgerMenuAgile";
      ...
      <NavBar style={barAnimation}>
        <FlexContainer>
          ...
          <NavLinks style={linkAnimation}>
            ...
            <a href="#section-footer">¡Hablemos!</a>

            <Button className="btn-nav-agile" onClick={handleShow}>
              Cotiza con nosotros
            </Button>
