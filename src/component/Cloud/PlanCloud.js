...
class PlanCloud extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <>
        ...
        >
          ...
          >
            ...
            <Card style={{ width: "100%" }} className="card-plan-cloud">
              <Card.Body className="card-body-plan-cloud">
                <Card.Title className="card-title-plan-cloud">
                  Standard Plan
                </Card.Title>
                <p>Our default plan</p>
                <ul className="ul-plan-cloud">
          ...
          >
            <Card
              style={{ width: "100%" }}
              className="card-plan-cloud card-custom-cloud  "
            >
              <Card.Body className="card-body-plan-cloud">
                <Card.Title className="card-title-plan-cloud ">
                  Custom-made plan
