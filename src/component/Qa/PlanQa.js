          ...
          >
            <>
              <h1 className={`${this.state.titleNormal}`}>
                {data.QA.sectionPlan.planTitle}
              </h1>
              <Carousel className="carousel-testimony">
                {data.QA.sectionPlan.testimonyList.map((plan, index) => (
            ...
            <Card style={{ width: "100%" }} className="card-plan-qa">
              <Card.Body className="card-body-plan-qa">
                ...
                <ul className="ul-plan-qa">
                  {data.QA.sectionPlan.planSmart.map((plan, index) => (
          ...
          >
            ...
            >
              <Card.Body className="card-body-plan-qa">
                ...
                <ul className="ul-plan-qa">
                  {data.QA.sectionPlan.planCostume.map((plan, index) => (
                    <li className="row" key={index}>
                      <div className="col-1 col-sm-1 col-md-1 col-lg-1 col-xl-1 col-ticket ">
                        <Image src={ticket} className="ticket"></Image>
                      </div>
