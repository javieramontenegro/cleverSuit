...
class ModalFormQa extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <>
        ...
        >
          ...
          >
            ...
            <div className="row row-succes-btn-qa">
              <Button
                onClick={
