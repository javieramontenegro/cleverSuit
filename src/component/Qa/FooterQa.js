...
class FooterQa extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <>
        ...
        ></ModalForm>
        <Row
          className={` container-footer-qa  ${this.props.classAnimationFooter}`}
        >
          ...
          <Row className="clerverSuit-footer ">
            ...
            <Col
              ...
              className=""
            >
              <Button className="btn-footer-qa" onClick={this.handleShow}>
                I want to know more!
              </Button>
            </Col>
          </Row>
