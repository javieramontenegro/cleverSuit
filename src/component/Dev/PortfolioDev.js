  ...
  render() {
    return (
      <>
        ...
        >
          ...
          >
            <h1 className="portfolio-title">
              {data.Development.sectionPortfolio.portfolioTitle}
            </h1>
          </Col>
        ...
        >
          {data.Development.sectionPortfolio.cards
                ...
                >
                  <Card style={{ width: "100%" }}>
                    ...
                    <Body className="card-body-portfolio">
                      ...
                      <Text className="area-text-dev">{card.area}</Text>
                    </Body>
                  </Card>
                </div>
              );
        ...
        <Row
          className={`  justify-content-center ${this.props.classAnimationPortfolio} `}
        >
          {this.state.visible < data.Development.sectionPortfolio.cards.length && (
            <Button
